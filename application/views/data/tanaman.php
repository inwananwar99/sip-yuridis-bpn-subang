...
<div class="row">
    ...
    <div class="col-md-3" style="margin-left: 500px;">
        <?= form_open('Inventarisasi/cariTanaman') ?>
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td><?= $d['jumlah']; ?></td>
                        <td>
                            <a class="btn btn-primary" href="<?= base_url('Inventarisasi/ubahInvTanaman/' . $d['id_tanaman']); ?>">Ubah</a>
...
?>
    <!-- Modal Hapus Produk-->
    <form id="add-row-form" action="<?= base_url() . 'Inventarisasi/hapusInvTanaman/' . $d['id_tanaman'] ?>">
    <?php } ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <strong>Apakah anda yakin ingin menghapus data ini dengan nama?</strong>
