<body >
<div class="container-fluid"  style="background-image: url(<?= base_url() ?>assets/img/bpn-ri.jpg); padding-bottom: 56px;">
  <div class="row" >
         <!-- Page Heading -->
        ...
        <div class="col-lg-8" style="background-color: white;  opacity: 0.9; margin-left: 170px; margin-top:50px">
            ...
            <form action="<?= base_url('Autor/ubahDataProfilAdmin/' . $pengguna['id_admin']); ?>" method="POST" enctype="multipart/form-data">

                <div class="form-group row">
                    <label for="input" class="col-sm-2 col-form-label">Nama Lengkap</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="input" name="nama" value="<?= $pengguna['nama']; ?>" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nama" class="col-sm-2 col-form-label">Username</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama" name="username" value="<?= $pengguna['username']; ?>" readonly>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="user" method="post" action="<?= base_url('Autor/ubahDataProfilAdmin/'.$pengguna['id_pengguna']); ?>">
                    ...
                    <div class="form-group row">
                        <label for="input" class="col-sm-2 col-form-label">Level Pengguna</label>
                        <div class="col-sm-8" style="margin-left: 20px; margin-top:10px;">
                            <input type="text" class="form-control" id="input" name="nl" value="<?= $pengguna['level']; ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="nama" class="col-sm-2 col-form-label">Username</label>
                    ...
                    <div class="form-group row">
                        <label for="nama" class="col-sm-2 col-form-label">Nomor Handphone</label>
                        <div class="col-sm-8" style="margin-left:20px; margin-top:10px;">
                            <input type="text" class="form-control" id="nama" name="no_hp" value="<?= $pengguna['no_hp']; ?>">
                            <?= form_error('nama', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>
                    </div>
